        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Proje Düzenle</h3>
                ...
                <div class="box-body">
                    ...
                    @endif
                    <form action="/proje-detay/{{ $project->id }}" method="post">
                        {{ csrf_field() }}
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="firm_name" class="form-control" value="{{ $project->firm_name }}" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="authorized" class="form-control" value="{{ $project->authorized }}" />
                                </td>
                            </tr>
                            <tr>
                                <td>
